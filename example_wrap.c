...
SWIGINTERN PyObject *_wrap_idle(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "idle", 0, 0, 0)) SWIG_fail;
  idle();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "prime", _wrap_prime, METH_O, NULL},
	 { "idle", _wrap_idle, METH_NOARGS, NULL},
